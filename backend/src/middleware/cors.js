...
export const corsMiddleware = (req, res, next) => {
  ...
  // X-Device-Id is generated by the frontend and is used by the session/device
  // cap. It must be listed here or browsers reject the signup/login preflight
  // before Express reaches the auth routes.
