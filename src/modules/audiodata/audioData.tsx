...
const q1_1fast = "/assets/1. Leo/quiz/1.leo's life/q1-fast.mp3";
const q1_1slow = "/assets/1. Leo/quiz/1.leo's life/q1-slow.mp3";
const q1_2fast = "/assets/1. Leo/quiz/1.leo's life/q2-fast.mp3";
const q1_2slow = "/assets/1. Leo/quiz/1.leo's life/q2-slow.mp3";
const q1_3fast = "/assets/1. Leo/quiz/1.leo's life/q3-fast.mp3";
const q1_3slow = "/assets/1. Leo/quiz/1.leo's life/q3-slow.mp3";
const q1_4fast = "/assets/1. Leo/quiz/1.leo's life/q4-fast.mp3";
const q1_4slow = "/assets/1. Leo/quiz/1.leo's life/q4-slow.mp3";
const q1_5fast = "/assets/1. Leo/quiz/1.leo's life/q5-fast.mp3";
const q1_5slow = "/assets/1. Leo/quiz/1.leo's life/q5-slow.mp3";

const q2_1fast = "/assets/1. Leo/quiz/2. leo's mornings/q1-fast.mp3";
const q2_1slow = "/assets/1. Leo/quiz/2. leo's mornings/q1-slow.mp3";
const q2_2fast = "/assets/1. Leo/quiz/2. leo's mornings/q2-fast.mp3";
const q2_2slow = "/assets/1. Leo/quiz/2. leo's mornings/q2-slow.mp3";
const q2_3fast = "/assets/1. Leo/quiz/2. leo's mornings/q3-fast.mp3";
const q2_3slow = "/assets/1. Leo/quiz/2. leo's mornings/q3-slow.mp3";
const q2_4fast = "/assets/1. Leo/quiz/2. leo's mornings/q4-fast.mp3";
const q2_4slow = "/assets/1. Leo/quiz/2. leo's mornings/q4-slow.mp3";
const q2_5fast = "/assets/1. Leo/quiz/2. leo's mornings/q5-fast.mp3";
const q2_5slow = "/assets/1. Leo/quiz/2. leo's mornings/q5-slow.mp3";

const q3_1fast = "/assets/1. Leo/quiz/3. leo's favorite food/q1-fast.mp3";
const q3_1slow = "/assets/1. Leo/quiz/3. leo's favorite food/q1-slow.mp3";
const q3_2fast = "/assets/1. Leo/quiz/3. leo's favorite food/q2-fast.mp3";
const q3_2slow = "/assets/1. Leo/quiz/3. leo's favorite food/q2-slow.mp3";
const q3_3fast = "/assets/1. Leo/quiz/3. leo's favorite food/q3-fast.mp3";
const q3_3slow = "/assets/1. Leo/quiz/3. leo's favorite food/q3-slow.mp3";
const q3_4fast = "/assets/1. Leo/quiz/3. leo's favorite food/q4-fast.mp3";
const q3_4slow = "/assets/1. Leo/quiz/3. leo's favorite food/q4-slow.mp3";
const q3_5fast = "/assets/1. Leo/quiz/3. leo's favorite food/q5-fast.mp3";
const q3_5slow = "/assets/1. Leo/quiz/3. leo's favorite food/q5-slow.mp3";

const q4_1fast = "/assets/1. Leo/quiz/4. leo's family/q1-fast.mp3";
const q4_1slow = "/assets/1. Leo/quiz/4. leo's family/q1-slow.mp3";
const q4_2fast = "/assets/1. Leo/quiz/4. leo's family/q2-fast.mp3";
const q4_2slow = "/assets/1. Leo/quiz/4. leo's family/q2-slow.mp3";
const q4_3fast = "/assets/1. Leo/quiz/4. leo's family/q3-fast.mp3";
const q4_3slow = "/assets/1. Leo/quiz/4. leo's family/q3-slow.mp3";
const q4_4fast = "/assets/1. Leo/quiz/4. leo's family/q4-fast.mp3";
const q4_4slow = "/assets/1. Leo/quiz/4. leo's family/q4-slow.mp3";
const q4_5fast = "/assets/1. Leo/quiz/4. leo's family/q5-fast.mp3";
const q4_5slow = "/assets/1. Leo/quiz/4. leo's family/q5-slow.mp3";

const q5_1fast = "/assets/1. Leo/quiz/5. leo's clothes/q1-fast.mp3";
const q5_1slow = "/assets/1. Leo/quiz/5. leo's clothes/q1-slow.mp3";
const q5_2fast = "/assets/1. Leo/quiz/5. leo's clothes/q2-fast.mp3";
const q5_2slow = "/assets/1. Leo/quiz/5. leo's clothes/q2-slow.mp3";
const q5_3fast = "/assets/1. Leo/quiz/5. leo's clothes/q3-fast.mp3";
const q5_3slow = "/assets/1. Leo/quiz/5. leo's clothes/q3-slow.mp3";
const q5_4fast = "/assets/1. Leo/quiz/5. leo's clothes/q4-fast.mp3";
const q5_4slow = "/assets/1. Leo/quiz/5. leo's clothes/q4-slow.mp3";
const q5_5fast = "/assets/1. Leo/quiz/5. leo's clothes/q5-fast.mp3";
const q5_5slow = "/assets/1. Leo/quiz/5. leo's clothes/q5-slow.mp3";

const q6_1fast = "/assets/1. Leo/quiz/6. a day at the beach/q1-fast.mp3";
const q6_1slow = "/assets/1. Leo/quiz/6. a day at the beach/q1-slow.mp3";
const q6_2fast = "/assets/1. Leo/quiz/6. a day at the beach/q2-fast.mp3";
const q6_2slow = "/assets/1. Leo/quiz/6. a day at the beach/q2-slow.mp3";
const q6_3fast = "/assets/1. Leo/quiz/6. a day at the beach/q3-fast.mp3";
const q6_3slow = "/assets/1. Leo/quiz/6. a day at the beach/q3-slow.mp3";
const q6_4fast = "/assets/1. Leo/quiz/6. a day at the beach/q4-fast.mp3";
const q6_4slow = "/assets/1. Leo/quiz/6. a day at the beach/q4-slow.mp3";
const q6_5fast = "/assets/1. Leo/quiz/6. a day at the beach/q5-fast.mp3";
const q6_5slow = "/assets/1. Leo/quiz/6. a day at the beach/q5-slow.mp3";

const q7_1fast = "/assets/1. Leo/quiz/7. a country that Leo wants to visit/q1-fast.mp3";
const q7_1slow = "/assets/1. Leo/quiz/7. a country that Leo wants to visit/q1-slow.mp3";
const q7_2fast = "/assets/1. Leo/quiz/7. a country that Leo wants to visit/q2-fast.mp3";
const q7_2slow = "/assets/1. Leo/quiz/7. a country that Leo wants to visit/q2-slow.mp3";
const q7_3fast = "/assets/1. Leo/quiz/7. a country that Leo wants to visit/q3-fast.mp3";
const q7_3slow = "/assets/1. Leo/quiz/7. a country that Leo wants to visit/q3-slow.mp3";
const q7_4fast = "/assets/1. Leo/quiz/7. a country that Leo wants to visit/q4-fast.mp3";
const q7_4slow = "/assets/1. Leo/quiz/7. a country that Leo wants to visit/q4-slow.mp3";
const q7_5fast = "/assets/1. Leo/quiz/7. a country that Leo wants to visit/q5-fast.mp3";
const q7_5slow = "/assets/1. Leo/quiz/7. a country that Leo wants to visit/q5-slow.mp3";

const q8_1fast = "/assets/1. Leo/quiz/8. leo's hobbies/q1-fast.mp3";
const q8_1slow = "/assets/1. Leo/quiz/8. leo's hobbies/q1-slow.mp3";
const q8_2fast = "/assets/1. Leo/quiz/8. leo's hobbies/q2-fast.mp3";
const q8_2slow = "/assets/1. Leo/quiz/8. leo's hobbies/q2-slow.mp3";
const q8_3fast = "/assets/1. Leo/quiz/8. leo's hobbies/q3-fast.mp3";
const q8_3slow = "/assets/1. Leo/quiz/8. leo's hobbies/q3-slow.mp3";
const q8_4fast = "/assets/1. Leo/quiz/8. leo's hobbies/q4-fast.mp3";
const q8_4slow = "/assets/1. Leo/quiz/8. leo's hobbies/q4-slow.mp3";
const q8_5fast = "/assets/1. Leo/quiz/8. leo's hobbies/q5-fast.mp3";
const q8_5slow = "/assets/1. Leo/quiz/8. leo's hobbies/q5-slow.mp3";

const q9_1fast = "/assets/1. Leo/quiz/9. meeting a friend/q1-fast.mp3";
const q9_1slow = "/assets/1. Leo/quiz/9. meeting a friend/q1-slow.mp3";
const q9_2fast = "/assets/1. Leo/quiz/9. meeting a friend/q2-fast.mp3";
const q9_2slow = "/assets/1. Leo/quiz/9. meeting a friend/q2-slow.mp3";
const q9_3fast = "/assets/1. Leo/quiz/9. meeting a friend/q3-fast.mp3";
const q9_3slow = "/assets/1. Leo/quiz/9. meeting a friend/q3-slow.mp3";
const q9_4fast = "/assets/1. Leo/quiz/9. meeting a friend/q4-fast.mp3";
const q9_4slow = "/assets/1. Leo/quiz/9. meeting a friend/q4-slow.mp3";
const q9_5fast = "/assets/1. Leo/quiz/9. meeting a friend/q5-fast.mp3";
const q9_5slow = "/assets/1. Leo/quiz/9. meeting a friend/q5-slow.mp3";

const q10_1fast = "/assets/1. Leo/quiz/10. the lost kitten/q1-fast.mp3";
const q10_1slow = "/assets/1. Leo/quiz/10. the lost kitten/q1-slow.mp3";
const q10_2fast = "/assets/1. Leo/quiz/10. the lost kitten/q2-fast.mp3";
const q10_2slow = "/assets/1. Leo/quiz/10. the lost kitten/q2-slow.mp3";
const q10_3fast = "/assets/1. Leo/quiz/10. the lost kitten/q3-fast.mp3";
const q10_3slow = "/assets/1. Leo/quiz/10. the lost kitten/q3-slow.mp3";
const q10_4fast = "/assets/1. Leo/quiz/10. the lost kitten/q4-fast.mp3";
const q10_4slow = "/assets/1. Leo/quiz/10. the lost kitten/q4-slow.mp3";
const q10_5fast = "/assets/1. Leo/quiz/10. the lost kitten/q5-fast.mp3";
const q10_5slow = "/assets/1. Leo/quiz/10. the lost kitten/q5-slow.mp3";
...
export const audioTracks: AudioTrack[] = [
  ...
  },
  {
    ...
    quiz: [
      ...
      {
        question: "Where does Leo buy his dough when he cooks at home?",
        options: [
          "A supermarket",
      ...
      {
        question: "What food does Leo never eat?",
  ...
  },
  {
    ...
    quiz: [
      {
        question: "Where does Leo's mother work now?",
        options: [
          "At a university",
          "At a local shop",
          "At an art gallery",
      ...
      {
        question: "Where did the two families go together in the past?",
        options: ["Italy", "France", "Thailand", "England"],
        correctAnswer: 2,
        referenceTime: 0,
        audio: { fast: q4_4fast, slow: q4_4slow },
      },
      {
        question: "What does Leo's father always say?",
        options: [
          "Work hard every day",
          "A real man decides by himself",
          "Family comes first",
          "Never give up",
        ],
        correctAnswer: 1,
  ...
  },
  {
    ...
    quiz: [
      ...
      {
        question: "How does Leo feel when he puts on a suit?",
        options: [
          "Elegant and happy",
          "Like he is at work",
  ...
  },
  {
    ...
    quiz: [
      ...
      {
        question: "What did Leo build on the beach?",
        options: [
          "A sand sculpture",
          "A fort",
          "A big castle",
      ...
      },
      {
        ...
        options: ["A big fish", "A dolphin", "A whale", "A shark"],
        correctAnswer: 3,
        referenceTime: 0,
...

  {
    ...
    quiz: [
      ...
      {
        question: "Why does Leo hate France?",
        options: [
  ...
  },
  {
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ["His father", "His friend", "His mother", "His sister"],
        correctAnswer: 3,
        referenceTime: 0,
