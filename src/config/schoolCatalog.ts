...
const VARIANT_COURTYARD: SchoolVariant = {
  ...
  rooms: [
    ...
    room("corridor", "corridor", "bitAward", 20, { x: 0, z: 8, w: 19, d: 3 }, {
      grows: [
        { when: ["classroomB", "archive"], rect: { x: 19, z: 8, w: 9, d: 3 } },
        { when: ["classroomD", "musicRoom"], rect: { x: 28, z: 8, w: 9, d: 3 } },
      ],
    }),
    room("library", "library", "bitWord", 30, { x: 12, z: 0, w: 7, d: 8 }),
    ...
    room("gym", "gym", "bitPhrase", 200, { x: 8, z: 20, w: 11, d: 10 }),
    // The second ring. East of the courtyard and south of the cafeteria, plus
    // one classroom out past the north row on either side.
    room("archive", "library", "bitWord", 450, { x: 19, z: 11, w: 9, d: 7 }),
    room("staffRoom", "staff", "bitPhrase", 220, { x: 19, z: 18, w: 9, d: 7 }),
    room("musicRoom", "music", "bitPhrase", 300, { x: 28, z: 11, w: 9, d: 8 }),
    room("office", "office", "bitAward", 550, { x: 28, z: 19, w: 9, d: 6 }),
    room("studyHall", "library", "bitWord", 800, { x: -24, z: 11, w: 11, d: 9 }),
    room("garden", "garden", "bitPhrase", 380, { x: -13, z: 23, w: 13, d: 8 }, { outdoor: true }),
    room("classroomD", "classroom", "bitAward", 850, { x: 28, z: 0, w: 9, d: 8 }),
    ...
    room("classroomE", "classroom", "bitAward", 1000, { x: -24, z: 20, w: 11, d: 8 }),
  ],
  doors: {
...
const VARIANT_QUAD: SchoolVariant = {
  ...
  rooms: [
    ...
    room("corridor", "corridor", "bitAward", 20, { x: 0, z: 8, w: 20, d: 3 }, {
      grows: [
    ...
    room("library", "library", "bitWord", 30, { x: 12, z: 0, w: 8, d: 8 }),
    ...
    room("gym", "gym", "bitPhrase", 200, { x: 20, z: 11, w: 11, d: 10 }),
    // The second ring hangs off the row below the corridor, and the west end
    // steps down past classroomC.
    room("archive", "library", "bitWord", 450, { x: 12, z: 18, w: 8, d: 8 }),
    room("staffRoom", "staff", "bitPhrase", 220, { x: -12, z: 21, w: 12, d: 8 }),
    room("musicRoom", "music", "bitPhrase", 300, { x: 20, z: 21, w: 11, d: 8 }),
    room("office", "office", "bitAward", 550, { x: 20, z: 29, w: 11, d: 7 }),
    room("studyHall", "library", "bitWord", 800, { x: -24, z: 8, w: 12, d: 8 }),
    room("garden", "garden", "bitPhrase", 380, { x: 12, z: 28, w: 8, d: 8 }, { outdoor: true }),
    room("classroomD", "classroom", "bitAward", 850, { x: 31, z: 0, w: 10, d: 8 }),
    // Board on the WEST wall: the study hall is pressed against its north side.
    room("classroomE", "classroom", "bitAward", 1000, { x: -24, z: 16, w: 12, d: 8 }),
  ],
  doors: {
...
const VARIANT_TERRACE: SchoolVariant = {
  ...
  rooms: [
    room("classroom", "classroom", "bitAward", 0, { x: 0, z: 0, w: 8, d: 7 }, { starter: true, grows: CLASSROOM_GROWTH }),
    room("corridor", "corridor", "bitAward", 20, { x: -9, z: 8, w: 21, d: 3 }, {
      grows: [{ when: ["hall", "cafeteria"], rect: { x: 12, z: 8, w: 13, d: 3 } }],
    }),
    room("library", "library", "bitWord", 30, { x: -9, z: 0, w: 9, d: 8 }),
    ...
    room("gym", "gym", "bitPhrase", 200, { x: 12, z: 20, w: 13, d: 10 }),
    // The street keeps running east, and the west end steps down past the lab.
    room("archive", "library", "bitWord", 450, { x: -9, z: 18, w: 9, d: 8 }),
    room("staffRoom", "staff", "bitPhrase", 220, { x: 25, z: 11, w: 11, d: 8 }),
    room("musicRoom", "music", "bitPhrase", 300, { x: 25, z: 19, w: 11, d: 8 }),
    room("office", "office", "bitAward", 550, { x: 25, z: 27, w: 11, d: 7 }),
    room("studyHall", "library", "bitWord", 800, { x: -21, z: 8, w: 12, d: 8 }),
    room("garden", "garden", "bitPhrase", 380, { x: -9, z: 26, w: 9, d: 8 }, { outdoor: true }),
    room("classroomD", "classroom", "bitAward", 850, { x: 34, z: 0, w: 12, d: 8 }),
    // Board on the WEST wall: the study hall is pressed against its north side.
    room("classroomE", "classroom", "bitAward", 1000, { x: -21, z: 16, w: 12, d: 8 }),
  ],
  doors: {
    classroom: { parent: "corridor", x: 6, z: 8 },
